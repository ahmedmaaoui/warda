...
if(isset($_GET['delete'])){
   ...
   mysqli_query($conn, "DELETE FROM `client_message` WHERE id = '$delete_id'") or die('query failed');
...
<section class="messages">
   ...
   <div class="box-container">
      ...
      <?php
       $select_message = mysqli_query($conn, "SELECT * FROM `client_message`") or die('query failed');
